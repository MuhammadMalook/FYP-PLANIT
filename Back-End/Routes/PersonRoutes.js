...
const { addPerson, login, getEventByUserId, updatePerson, getAllpersons, deletePerson, getPersonByID,
        ...
        getUnCompletedTasksByUser, completeTasks, myEvents, getAllNames, getEventsInfo, getDeviceToken, getNumberByName, UpdatePassword, check} = require('../controllers/PersonController');
